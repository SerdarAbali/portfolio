...
export function XIcon({ size = 20, ...props }: BrandIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function YouTubeIcon({ size = 20, ...props }: BrandIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function BrandIcon({
  ...
  size = 20,
  ...props
}: BrandIconProps & { brand: "github" | "linkedin" | "x" | "youtube" }) {
  if (brand === "github") return <GitHubIcon size={size} {...props} />;
  if (brand === "linkedin") return <LinkedInIcon size={size} {...props} />;
  if (brand === "youtube") return <YouTubeIcon size={size} {...props} />;
